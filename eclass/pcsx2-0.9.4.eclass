...
SRC_URI="mirror://sourceforge/pcsx2/pcsx2-0.9.4.tar.gz"
...
PROVIDE="virtual/ps2emu-${CN/\/*/}-0-9-4"
RDEPEND="
	>=x11-libs/gtk+-2.6.1
"
DEPEND="
...
pcsx2_unpack() {
	tar xzvpf "${DISTDIR}/8022" "${CNP:1}" >/dev/null || die "unpack failed"
}
pcsx2-0.9.4_src_unpack() { pcsx2_unpack "$@"; }
