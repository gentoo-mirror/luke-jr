...
SRC_URI="http://tesseract-ocr.googlecode.com/files/${P}.tar.gz
	linguas_vi? ( http://tesseract-ocr.googlecode.com/files/${P}.vie.tar.gz )
	linguas_de? ( http://tesseract-ocr.googlecode.com/files/${P}.deu-f.tar.gz )
	linguas_pt? ( http://tesseract-ocr.googlecode.com/files/${P}.por.tar.gz )
	linguas_pt_BR? ( http://tesseract-ocr.googlecode.com/files/${P}.por.tar.gz )
	linguas_pt_PT? ( http://tesseract-ocr.googlecode.com/files/${P}.por.tar.gz )
...
IUSE="tiff linguas_de linguas_en linguas_es linguas_fr linguas_it linguas_pt linguas_pt_BR linguas_pt_PT linguas_nl linguas_vi"
